...
exportBtn=Button(manageFrame,text="EXPORT EXCEL",width=15,borderwidth=3,bg=btnColor,fg='black',command=exportExcel)
...
categoryArray=['Apple','Samsung','Lenovo','HP','Dell']
